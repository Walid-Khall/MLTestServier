...
def data_prepocessing(csv_filepath):
    ...
    df['extracted features'] = df.apply(lambda row : fingerprint_features(row['smiles']), axis = 1)
...
def main():
    if len(sys.argv) == 3:
        ...
        print('Please provide the filepath of the dataset '
              'as the first argument and the filepath of the h5 file to '
              'save the model to as the second argument. \n\nExample: python '
              'train_classifier.py ../data/dataset_single.csv model1.h5')
